...
import { DraggableCardDemo } from "@/components/aceternity/draggable";
import { CometCardDemo } from "@/components/aceternity/commet-card";
...
const HeroSection = ({ components, category }: Props) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="stat-item text-center">
              <div
                ...
                data-value={components.flat().length}
              >
                0
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {showcase_components.map((i, index) => (
              <Card
                className="showcase-item overflow-hidden group hover:shadow-xl transition-all duration-300 py-0!"
                key={index}
              >
                <Link href={i.link}>
                  <div className="relative border-b min-h-70 flex items-center justify-center p-6">
                    <div
                    ...
                    <div className="relative z-10 flex items-center justify-center">
                      <div className="relative group-hover:scale-[1.02] transition-transform duration-300">
                        <img
                          src={i.src}
                          alt="Feature 1"
                          className="rounded-lg border-2 border-border shadow-2xl shadow-primary/20 w-full h-full object-cover"
                        />
